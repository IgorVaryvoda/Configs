...
-- {{{ Tags
 ...
 tags = {
   names  = { "main", "www", "im", "torrent", "office" },
   layout = { layouts[1], layouts[1], layouts[3], layouts[5], layouts[5]
 }}
...
-- Alt + Right Shift switches the current keyboard layout
    awful.key({ "Mod1" }, "Shift_L", function () os.execute(kbd_dbus_prev_cmd) end),
